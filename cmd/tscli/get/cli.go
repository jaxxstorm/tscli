...
import (
	...
	postureintegration "github.com/jaxxstorm/tscli/cmd/tscli/get/integration"
	...
	"github.com/jaxxstorm/tscli/cmd/tscli/get/service"
...
func Command() *cobra.Command {
	...
	command.AddCommand(oauthapp.GetCommand())
